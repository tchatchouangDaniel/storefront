...
var UsersStore = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_1 = _a.sent();
                        throw new Error("Unable to fetch all the users : " + error_1);
    ...
    UsersStore.prototype.create = function (username, firstname, lastname, password) {
        return __awaiter(this, void 0, void 0, function () {
            var conn, sql, passwordHash, result, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 1:
                        ...
                        passwordHash = bcrypt_1["default"].hashSync("" + password + pepper, saltRounds);
                        return [4 /*yield*/, conn.query(sql, [
                                username,
                                firstname,
                                lastname,
    ...
    UsersStore.prototype.update = function (id, firstname, lastname, newPassword) {
        return __awaiter(this, void 0, void 0, function () {
            var conn, sql, result, passwordHash, error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 9, , 10]);
                    ...
                    case 6:
                        ...
                        return [4 /*yield*/, conn.query(sql, [passwordHash, id])];
                    case 7:
                        result = _a.sent();
                        _a.label = 8;
                    case 8:
                    ...
                    case 9:
                        error_4 = _a.sent();
                        throw new Error("Unable to update a user : " + error_4);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_5 = _a.sent();
                        throw new Error("Unable to delete user : " + error_5);
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    UsersStore.prototype.resetTable = function () {
        return __awaiter(this, void 0, void 0, function () {
