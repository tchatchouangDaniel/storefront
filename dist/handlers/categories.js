...
var store = new categories_1.CategoriesStore();
/**
...
var index = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                error_1 = _a.sent();
                res.status(400).send("Unable to find all categories : " + error_1);
                return [3 /*break*/, 3];
...
var show = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                error_2 = _a.sent();
                res.status(400).send("Unable to find category : " + error_2);
                return [3 /*break*/, 3];
            case 3: return [2 /*return*/];
        }
    });
...
var create = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var name_1, result, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                name_1 = _req.body.name;
                if (!name_1)
                    throw new Error('No parameters provided');
                return [4 /*yield*/, store.create(name_1)];
            case 1:
                result = _a.sent();
                res.send(result);
                return [3 /*break*/, 3];
            case 2:
                error_3 = _a.sent();
                res.status(400).send("Unable to create category : " + error_3);
                return [3 /*break*/, 3];
            case 3: return [2 /*return*/];
        }
    });
...
var update = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, name_2, result, error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                id = _req.body.id;
                name_2 = _req.body.name;
                if (!id || !name_2)
                    throw new Error('Missing parameters');
                return [4 /*yield*/, store.update(id, name_2)];
            case 1:
                result = _a.sent();
                res.send(result);
                return [3 /*break*/, 3];
            case 2:
                error_4 = _a.sent();
                res.status(400).send("Unable to update category : " + error_4);
                return [3 /*break*/, 3];
            case 3: return [2 /*return*/];
        }
    });
...
var remove = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                error_5 = _a.sent();
                res.status(400).send("Unable to remove category : " + error_5);
                return [3 /*break*/, 3];
            case 3: return [2 /*return*/];
        }
    });
}); };
var categoriesRoute = function (app) {
