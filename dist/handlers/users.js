...
var index = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                error_1 = _a.sent();
                res.status(400).send("Unable to show all users : " + error_1);
                return [3 /*break*/, 3];
...
var create = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, username, firstname, lastname, password, result, token, error_3;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                _a = _req.body, username = _a.username, firstname = _a.firstname, lastname = _a.lastname, password = _a.password;
                if (!username || !firstname || !lastname || !password)
                    throw new Error('Unable to create a new user');
                return [4 /*yield*/, store.create(username, firstname, lastname, password)];
            case 1:
                result = _b.sent();
            ...
            case 2:
                error_3 = _b.sent();
                res.status(400).send("Unable to show user : " + error_3);
                return [3 /*break*/, 3];
            case 3: return [2 /*return*/];
        }
    });
...
var update = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, _a, firstname, lastname, newpassword, result, error_4;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                ...
                if (!id)
                    throw new Error('Missing id parameter');
                _a = _req.body, firstname = _a.firstname, lastname = _a.lastname, newpassword = _a.newpassword;
                if (!firstname && !lastname && !newpassword)
                    throw new Error('Missing parameter(s)');
                return [4 /*yield*/, store.update(firstname, lastname, newpassword)];
            case 1:
                result = _b.sent();
                res.send(result);
                return [3 /*break*/, 3];
            case 2:
                error_4 = _b.sent();
                res.status(400).send("Unable to update user infos : " + error_4);
                return [3 /*break*/, 3];
            case 3: return [2 /*return*/];
        }
    });
...
var remove = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                error_5 = _a.sent();
                res.status(400).send("Unable to delete user : " + error_5);
                return [3 /*break*/, 3];
            case 3: return [2 /*return*/];
        }
    });
...
var login = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, username, password, result, token, error_6;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                ...
                if (!username || !password)
                    throw new Error('Missing parameter(s)');
                return [4 /*yield*/, store.login(username, password)];
            case 1:
                result = _b.sent();
                if (!result)
            ...
            case 2:
                error_6 = _b.sent();
                res.status(400).send("Unable to authenticate : " + error_6);
                return [3 /*break*/, 3];
            case 3: return [2 /*return*/];
        }
    });
